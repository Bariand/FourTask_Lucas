...
namespace FourTask_Lucas.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [EmailAddress]
            [Display(Name = "E-mail")] //Coloquei um tracinho
            ...
            [StringLength(100, ErrorMessage = "A {0} deve ter pelo menos {2} caracteres e no máximo {1} characteres.", MinimumLength = 6)]
            [DataType(DataType.Password)]
            [Display(Name = "Senha")] //Traduzi isso aqui
            ...
            [Compare("Password", ErrorMessage = "As senhas inseridas não são iguais!")]
            public string ConfirmPassword { get; set; }


            //Propriedade colocada por mim
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.DataNascimento = Input.DataNascimento; //Lucas
